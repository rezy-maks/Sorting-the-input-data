...
// -nt - сортировка из файла от меньшего к большему, результат записывается в
// файл -rnt - сортировка из файла от большего к меньшему, результат
// записывается в файл
...
int main(int argc, char* argv[])
{
    if (argc == 1) {
        ...
        printf("-nt - сортировка из файла от меньшего к большему, результат записывается в файл\n");
        printf("rnt - сортировка из файла от большего к меньшему, результат записывается в файл\n");
        printf("-nc - сортировка от меньшего к большему из входных данных, введённых в консоль, результат выводится в консоль\n");
        printf("-rnc - сортировка от большего к меньшему из входных данных, введённых в консоль, результат выводится в консоль\n");
        printf("-tf - сортировка текста в алфавитном порядке, заданного файлом, результат выводится в консоль (чувствителена к регистру)\n");
        printf("-rtf - сортировка текста в обратном алфавитном порядке, заданного файлом, результат выводится в консоль (чувствителена к регистру)\n");
    }
